                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-8">
                                        <div className="hero__caption">
                                            ...
                                            {/* <P data-animation="fadeInUp" data-delay=".8s">
                                                jhorem rfpsum golor sidt amet, consectetur adipiscing elit, eiusmod
                                                tempor incididunt utcjhg labore bet dolore magna aliqua. Quis ipsum
                        ...
                        <div className="row ">
                            <div className="col-lg-5">
                                <div className="about-caption mb-50">
                                    ...
                                    <p className="pera1">
                                        Consectetur adipiscing elit, sed do eiusmod tempor ididunt ut labore et dolore
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-cat text-center mb-50">
                                    ...
                                    <div className="cat-cap">
                                        ...
                                        <p>
                                            Free resource that will help nderstand thecv designc process and improve
                        ...
                        <div className="row justify-content-between">
                            <div className="col-xl-5 col-lg-7">
                                <div className="contact-caption mb-50">
                                    ...
                                    <p>
                                        Consectetur adipiscing elit, sed do eiusmod tempor ididunt ut labore et dolore
                                        magna aliqua. Quis ipsum suspendisces gravida. Risus commodo viverra.
                                    </p>
